...
GPUs are referenced in a `compose.yaml` file using the [devices](/reference/compose-file/deploy.md#devices) attribute from the Compose Deploy specification, within your services that need them.
